...
class AuditLog extends Model
{
    ...
    public function getActionLabelAttribute(): string
    {
        return match ($this->action) {
            ...
            'session.force_logout'  => 'Logout Paksa',
            'perangkat_daerah.merged' => 'Gabung Perangkat Daerah',
            'perangkat_daerah.created' => 'Tambah Perangkat Daerah',
            'sub_kegiatan.created'  => 'Tambah Kegiatan/Sub Kegiatan',
            'program.updated'       => 'Ubah Nama Program',
            'kegiatan.updated'      => 'Ubah Nama Kegiatan',
            'hierarki.imported'     => 'Import Hierarki (Excel)',
            'menu.updated'          => 'Ubah Aktivasi Menu',
            'strategi.updated'      => 'Ubah Label Strategi',
            ...
            'pic.invited'           => 'Tambah PIC',
            'pic.removed'           => 'Hapus PIC',
            'auth.login'            => 'Login',
